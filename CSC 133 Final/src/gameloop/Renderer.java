...
public class Renderer{
	...
	public static void render(Graphics g, List<gameString> gs, Sprites sps, Sprites background, List<gameString> hudtext, Sprites hud, List<gameString> dialoguetext, Sprites dialogue, Sprites overlays, float alpha, boolean isFade){
		 ...
		 * with the rest of the game engine. */
	        ...
	        // Background sprites...
                Iterator<Sprite> it4 = background.getIterator();
                while(it4.hasNext()) {
                        Sprite tmp = it4.next();
		...
		// Dialogue sprites...
                Iterator<Sprite> it3 = dialogue.getIterator();
                while(it3.hasNext()) {
                        Sprite tmp = it3.next();
                        g.drawImage(tmp.getSprite(), tmp.getX(), tmp.getY(), null);
                }
